...
* The average maximum temperature is `r round(mean(pull(weather_df, tmax), na.rm = TRUE), digits = 2)` tenths of degrees C with the standard deviation of `r round(sd(pull(weather_df, tmax), na.rm = TRUE), digits = 2)` tenths of degrees C. The range of between maximum temperature during the period is between `r max(pull(weather_df, tmax), na.rm = TRUE)` tenths of degrees C and `r min(pull(weather_df, tmax), na.rm = TRUE)` tenths of degrees C. 
